...
function renderHtml(db, meta) {
  ...
  const indexHead = `<tr class="ixh">
    <th>ADR</th><th>Visión</th><th>implementación</th>
...
<style>
  :root{--bg:#faf7f2;--card:#fffdfa;--ink:#1f1d1a;--dim:#6f685f;--line:#e6e0d6;--accent:#2f7d4f;
        --green:#2f7d4f;--amber:#c98a1a;--amber-ink:#8a5b08;--muted:#786f65;--red:#a4402f}
  *{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--ink);font:14px/1.5 -apple-system,Segoe UI,Roboto,sans-serif;padding:18px 24px}
  header{max-width:1160px;margin:0 auto 12px}h1{margin:0 0 2px;font-size:22px;letter-spacing:-.01em}.sub{color:var(--dim)}
  .kpis{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));margin-top:8px;background:var(--card);border:1px solid var(--line);border-radius:10px;overflow:hidden}
  .kpi{padding:8px 10px;min-width:0;border-right:1px solid var(--line)}
  .kpi:last-child{border-right:0}.kpi:nth-child(2){background:#f3f8f4}
  .kpi b{font-size:20px;line-height:1.15;display:block;font-variant-numeric:tabular-nums}.kpi span{color:var(--dim);font-size:11px;white-space:nowrap}
  main{max-width:1160px;margin:0 auto}
  section{background:var(--card);border:1px solid var(--line);border-radius:10px;padding:12px 14px;margin-bottom:10px;overflow-x:auto}
  section table{min-width:900px}
  section:target{box-shadow:0 0 0 2px var(--accent)}
  h2{font-size:16px;margin:0 0 8px;display:flex;align-items:center;gap:8px;scroll-margin-top:12px}h2 small{color:var(--dim);font-weight:400}
  table{width:100%;border-collapse:collapse}th,td{text-align:left;padding:6px 8px;border-bottom:1px solid var(--line);font-size:13px;vertical-align:middle}
  ...
  .ax{color:var(--dim)}.impl-E2E-VERIFIED{color:var(--green);font-weight:600}.impl-PARTIAL{color:var(--amber-ink);font-weight:600}
  ...
  .barrido{margin-top:8px;background:var(--card);border:1px solid var(--line);border-radius:10px;padding:8px 12px}
  .barrido .bh{display:flex;justify-content:space-between;align-items:baseline;gap:8px;flex-wrap:wrap;margin-bottom:4px}
  ...
  .bbar i{height:100%}
  .bleg{display:flex;gap:16px;margin-top:4px;font-size:12px;font-weight:600}
  .bexist{color:var(--green)}.bpart{color:var(--amber-ink)}.bmiss{color:var(--muted)}
  ...
  .bpill.SD{background:#f4f0e9;color:var(--dim)}
  /* índice consolidado */
  .index{background:var(--card);border:1px solid var(--line);border-radius:10px;padding:2px 0 0;margin-bottom:10px;overflow-x:auto}
  .index table{width:100%;min-width:1160px}
  .index tbody tr:not(.grp){height:30px}
  .index tr.grp th{background:#f4efe6;color:#6b6459;font-size:11px;letter-spacing:.12em;font-weight:700;
    padding:6px 12px;text-transform:uppercase;border-bottom:1px solid var(--line)}
  .index td{padding:5px 10px}
  .index td.ix{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;color:var(--dim);width:68px;padding-left:12px}
  ...
  .index tr.ixh th{font-size:10px;color:var(--dim);padding:7px 10px 4px;border-bottom:1px solid var(--line)}
  ...
  .axes{padding:3px 12px;color:var(--dim);font-size:12px;line-height:1.35;border-bottom:1px solid var(--line);background:#fdfbf7}
  ...
  @media (max-width:720px){
    body{padding:12px}.kpis{grid-template-columns:repeat(4,minmax(0,1fr))}
    .kpi{border-bottom:1px solid var(--line)}.kpi:nth-child(4n){border-right:0}
    .kpi:nth-last-child(-n+3){border-bottom:0}.index{margin-inline:0}
  }
  @media (max-width:520px){
    .kpis{grid-template-columns:repeat(2,minmax(0,1fr))}.kpi:nth-child(4n){border-right:1px solid var(--line)}
    .kpi:nth-child(2n){border-right:0}.kpi:nth-last-child(-n+3){border-bottom:1px solid var(--line)}.kpi:last-child{border-bottom:0}
  }
</style></head><body>
<header>
