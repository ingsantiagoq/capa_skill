...
function lintCapa(dir, graph) {
  ...
  // Si esa afirmación se apoya en una prueba de infra que NO califica (sin infra:true, o sin
  // decisión ACEPTADA), la afirmación no tiene respaldo: BLOQUEO, no aviso. Con el aviso, un
  // objetivo podía anunciarse verificado apoyándose en una prueba que el propio DP-12 no cuenta.
